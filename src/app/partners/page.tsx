                ...
                <div className="flex flex-wrap justify-center gap-4 mb-12">
                  {Object.entries(partnerCategories).map(([key, category]: [string, any]) => (
                    <button
                      ...
                      className={`flex items-center px-6 py-3 rounded-full font-medium transition-all duration-300 ${activeTab === key
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <a
                href="https://wa.me/8452867115?text=Hi%2C%20I%27m%20interested%20in%20partnering%20with%20Upsy.%20Could%20you%20please%20provide%20more%20information%3F"
                target="_blank"
